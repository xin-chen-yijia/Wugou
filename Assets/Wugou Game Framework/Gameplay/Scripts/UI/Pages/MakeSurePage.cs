...
namespace Wugou.UI
{
    public class MakeSurePage : UIBaseWindow
    {
        ...
        public void Show(string content, UnityAction okAction, UnityAction cancelAction = null, string okLabel = "确定", string cancelLabel = "取消")
        {
        ...
        public void Show(string content, System.Action onOk = null)
        {
            content_.text = content;
