...
namespace Wugou
{
    ...
    public class MouseLook
    {
        ...
        public void LookRotation()
        {
            ...
            if (smooth)
            {
                m_Character.localRotation = Quaternion.Slerp(m_Character.localRotation, m_CharacterTargetRot,
                    smoothTime * Time.deltaTime);
                m_Camera.localRotation = Quaternion.Slerp(m_Camera.localRotation, m_CameraTargetRot,
                    smoothTime * Time.deltaTime);
            }
            else
            {
