...
namespace Wugou
{
    ...
    public class CoroutineAssetPackageLoader
    {
        ...
        private AssetBundleDescFile assetbundleLauchDesc_ = null; //assetbundle 描述信息
        ...
        private IEnumerator LoadAssetBundleLaunchConfig()
        {
            ...
            else
            {
                ...
                assetbundleLauchDesc_ = JsonConvert.DeserializeObject<AssetBundleDescFile>(configContent);
                if (assetbundleLauchDesc_ == null)
                {
