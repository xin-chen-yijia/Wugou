...
namespace Wugou.Editor.UI
{
    public class HierachyPage : UIBaseWindow
    {
        ...
        void Start()
        {
            GameMapEditor.instance.onSelectGameEntity.AddListener(OnSelectGameEntity);
            GameMapEditor.instance.onGameEntityAdd.AddListener(OnAddGameEntity);
            GameMapEditor.instance.onGameEntityDestory.AddListener(OnRemoveGameEntity);
            GameMapEditor.instance.onLoadedMap.AddListener(OnLoadedGameMap);
        ...
        public override void OnDestroy()
        {
            ...
            {
                GameMapEditor.instance.onSelectGameEntity.RemoveListener(OnSelectGameEntity);
                GameMapEditor.instance.onGameEntityAdd.RemoveListener(OnAddGameEntity);
                GameMapEditor.instance.onGameEntityDestory.RemoveListener(OnRemoveGameEntity);
                GameMapEditor.instance.onLoadedMap.RemoveListener(OnLoadedGameMap);
            }
        }
    }
