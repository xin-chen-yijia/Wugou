...
namespace Wugou.Editor.UI
{
    public class AssetsPage : UIBaseWindow
    {
        ...
        private List<UnityMainThreadTask> iconUpdateTasks_ = new List<UnityMainThreadTask>();
            ...
            searchInput.onSubmit.AddListener((string value) =>
            {
                ...
                if (!nullSearch)
                {
                    ...
                    for (int i = 0; i < GameMapEditor.instance.groupCount; ++i)
                    {
                        ...
                        {
                            var assetItem = GameMapEditor.instance.GetIAssettem(i, j);
                    ...
                    UnityMainThreadTask task = new UnityMainThreadTask();
        ...
        public void UpdateBoard()
        {
            ...
            UnityMainThreadTask task = new Wugou.UnityMainThreadTask();
            ...
            Utils.FillContent(sectionContainer, sectionPrefab, groups, (GameObject section, int group) =>
            {
                ...
                {
                    var assetItem = GameMapEditor.instance.GetIAssettem(group, itemIndex);
                    IntantiateAssetItem(go, assetItem, task);
                }, false);
        ...
        private void IntantiateAssetItem(GameObject go, EditorAssetItem assetItem, UnityMainThreadTask task)
        {
