...
namespace Wugou.Editor
{
    ...
    public class ScriptCompileReloadTools
    {
        ...
        const string menuEnableManualReload = PluginGlobalDefine.MenuName + "/Script Load/开启手动Reload Domain";
        const string menuDisenableManualReload = PluginGlobalDefine.MenuName + "/Script Load/关闭手动Reload Domain";
        const string menuRealodDomain = PluginGlobalDefine.MenuName + "/Script Load/Unlock Reload %t";
