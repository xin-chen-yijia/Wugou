...
namespace Wugou
{
    ...
    public class GameMap
    {
        ...
        // 模拟天气
        public WeatherSetting weather = new WeatherSetting();
        ...
        public void Parse(string content)
        {
            ...
            weather = reader.Read<WeatherSetting>("gameworld/weather");
    ...
    /// <summary>
    /// 写地图文件，注意GameEntity因为是GameObject，所以需要加载后才会实例化，保存的时候是读取GameWorld记载的GameEntity
    /// </summary>
