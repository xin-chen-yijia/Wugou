...
namespace Wugou
{
    public class Authorization
    {
        ...
        public static async Task<bool> Login(string username, string password)
        {
            ...
            Debug.Log($"{GameConsole.settings.host}/api/signIn");
            using (UnityWebRequest webRequest = UnityWebRequest.Post($"{GameConsole.settings.host}/api/signIn", form))
            {
                ...
                switch (webRequest.result)
                {
                    ...
                    case UnityWebRequest.Result.Success:
                        ...
                        if(!string.IsNullOrEmpty(data))
                        {
                            ...
                            PlayerPrefs.SetString(GameConsole.kPREFS_KEY_AUTH, JsonConvert.SerializeObject(activeUser));
        ...
        {
            PlayerPrefs.DeleteKey(GameConsole.kPREFS_KEY_AUTH);
            activeUser = null;
        }

        public static bool LoadAuthCache()
        {
            var authInfo = PlayerPrefs.GetString(GameConsole.kPREFS_KEY_AUTH);
