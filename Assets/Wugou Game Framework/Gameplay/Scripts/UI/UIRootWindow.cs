...
namespace Wugou.UI
{
    ...
    public class UIRootWindow : UIBaseWindow
    {
        ...
        private static UIRootWindow additionalWindow
        {
            get
            {
        ...
        /// </summary>
        //public static bool isInitialized => _additionalWindow != null;
        ...
        public static UIBaseWindow GetWindow(Type type)
        {
            if (pages_.ContainsKey(type))
            {
                if (pages_[type] != null)
