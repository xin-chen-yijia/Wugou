...
{
    [Obsolete("不好用，用EditorAxis")]
    public class EditorAxis2
    {
        ...
        public EditorAxis2(GameObject gameObject)
        {
            gameObject_ = gameObject;
            gameObject_.SetLayerRecursively(MapEditorSystem.mapToolLayer);
        }
        ...
        public void Update()
        {
            if (Input.GetMouseButtonDown(0)) {
                ...
                // 选择坐标轴等工具
                if (Physics.Raycast(ray, out hit, maxRayDistance, 1 << MapEditorSystem.mapToolLayer))
                {
                    // TODO:高亮物体
