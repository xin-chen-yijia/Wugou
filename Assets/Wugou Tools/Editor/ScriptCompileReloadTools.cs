...
namespace Wugou.Editor
{
    ...
    public class ScriptCompileReloadTools
    {
        ...
        const string menuEnableManualReload = ConstDefines.MenuName + "/Script Load/开启手动Reload Domain";
        const string menuDisenableManualReload = ConstDefines.MenuName + "/Script Load/关闭手动Reload Domain";
