...
namespace Wugou.Editor
{
    public class PropertyViewManager : MonoBehaviour
    {
        ...
        public BoolPropertyView boolView;
        ...
        private void Awake()
        {
            ...
            views.Add(typeof(bool), (MemberInfo t) =>
            {
                var po = Instantiate<GameObject>(boolView.gameObject, transform);
                po.SetActive(true);

                return po.GetComponent<BoolPropertyView>();
            });
        }
        ...
        public GameComponentView GetViewOfComponent(Type t)
        {
            ...
            if (t.GetCustomAttribute<DefaultGameComponentViewAttribute>() == null)
            {
                return null;
            }
