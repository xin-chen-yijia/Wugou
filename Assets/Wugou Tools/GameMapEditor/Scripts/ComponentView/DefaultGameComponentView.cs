...
namespace Wugou.Editor
{
    ...
    public class PropertyViewNameAttribute : Attribute
    {
        public string name { get;private set; }
        public PropertyViewNameAttribute(string name)
        {
            this.name = name;
        }
    }
        ...
        public void Init(Type t)
        {
            ...
            foreach (var field in t.GetFields(System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.Instance))
            {
                ...
                if (viewObj)
                {
                    ...
                    var pNameAttr = field.GetCustomAttribute<PropertyViewNameAttribute>(false);
                    if (pNameAttr != null)
                    {
                        viewObj.head = pNameAttr.name;
                    }
