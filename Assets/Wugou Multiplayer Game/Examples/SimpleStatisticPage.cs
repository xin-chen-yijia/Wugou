...
namespace Wugou.Examples.UI
{
    public class SimpleStatisticPage : UIBaseWindow
    {
        ...
        public void SetTrainingRecord(List<SimpleGameStats> records)
        {
        ...
        public void SetGameStats(SimpleGameStats stats)
        {
            Utils.FillContent(statsContainer, statsPrefab, stats.playerStats.Values.ToList(), (item, snapshot) =>
            {
